  ...
  try {
    ...
    if (!template || template.channel !== "whatsapp") {
      return NextResponse.json(
        { message: "व्हाट्सएप टेम्पलेट नहीं मिला।" },
        { status: 400 },
      );
    }
    ...
    if (previewOnly) {
      return NextResponse.json({
        ...
        message:
          "प्रीव्यू मोड सक्रिय है। उत्पादन में व्हाट्सएप संदेश भेजने के लिए Twilio क्रेडेन्शियल सेट करें।",
      });
    }
    ...
    await client.messages.create({
      body: messageBody,
      from: fromNumber,
      to: body.phone.startsWith("whatsapp:")
        ? body.phone
        : `whatsapp:${body.phone}`,
    });
    ...
    const message =
      error instanceof Error
        ? error.message
        : "व्हाट्सएप संदेश भेजने में त्रुटि।";
